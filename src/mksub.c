...
@section mksub-syntax Command Line
<pre>
...
@section mksub-out Output Files
@par @em Name.cfinfo
  Constituent info file.
@par @em Name.out
  Submodule lattice.
...
@section mksub-desc Description
...
@subsection mksub-of Changing the Output Format
